...
| Project | Description | Link |
|--------|-------------|------|
| Project Aurora Echo | Real-time meeting copilot | https://github.com/NathanMaine/Project-Aurora-Echo |
| Realtime AI Assistant | FastAPI template | https://github.com/NathanMaine/realtime-ai-assistant |
| Streamlit Assistant v4 | Streamlit + ASR | https://github.com/NathanMaine/realtime-ai-assistant004-stream-lit |
| FastAPI Assistant v3 | Fast backend variant | https://github.com/NathanMaine/realtime-ai-assistant003-fast-api |
| Streamlit Assistant v2 | Early ASR → LLM pipeline prototype | https://github.com/NathanMaine/realtime-ai-assistant002 |
...
| Project | Description | Link |
|--------|-------------|------|
| Agentforce Data-Aware Agent | Metadata-aware safe action execution | https://github.com/NathanMaine/Agentforce-Data-Aware-Agent |
| Dynamic Action | Generates Apex actions | https://github.com/NathanMaine/Agentforce-Dynamic-Action |
| Dynamic Action (Invocable) | Flow-compatible action generator | https://github.com/NathanMaine/Agentforce-Dynamic-Action-Invocable |
...
| Project | Description | Link |
|--------|-------------|------|
| Backward-Chaining Engine | Goal-driven inference | https://github.com/NathanMaine/LISP-Backward-Chaining-Core-Engine |
| Car Expert System | Rule-based troubleshooting system | https://github.com/NathanMaine/lisp-car-expert-system |
...
| Project | Description | Link |
|--------|-------------|------|
| Chess Analyzer v2 | Web-based PGN analysis | https://github.com/NathanMaine/Chess-Analyzer-v2 |
| Chess Analyzer (Python) | PGN parsing engine | https://github.com/NathanMaine/chess-analyzer |
